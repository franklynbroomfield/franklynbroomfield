...
<html>
<head>
<title>FRANKLYN  BROOMFIELD</title>
<meta charset="UTF-8">
...
.bgimg-1 {
  background-image: url('Blackbird - Realtor Show.jpeg');
width="1500" height="1000"  width="1500" height="1000";
}

/* Second image (Portfolio) */
.bgimg-2 {
  background-image: url("United Nations Annivesary Signing-Set Up @ Mellon.jpeg");
  min-height: 200px;
}

/* Third image (Contact) */
.bgimg-3 {
  background-image: url("2011 Stunt Show TD Award.jpg");
  min-height: 400px;
}
